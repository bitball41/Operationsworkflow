...
const classify = require("../js/services/openscout/classify.js");
const verify = require("../js/services/openscout/verify.js");
const location = require("../js/services/openscout/location.js");
